...
export class TenantService {
  ...
  async loadUserTenants(): Promise<void> {
    ...
    try {
      ...
      const currentTenant = savedTenantId 
  ...
  async loadTenantPermissions(tenantId: string): Promise<void> {
    try {
      const permissions = await this.apiService.get<TenantPermission[]>(
  ...
  async loadTenantSettings(tenantId: string): Promise<void> {
    try {
      const settings = await this.apiService.get<TenantSettings>(
  ...
  hasPermission(permission: string): boolean {
    ...
    return permissions.some(p => 
      p.resource + '.' + p.action === permission && p.granted
    );
  }
    ...
    <div class="tenant-selector">
      @if (canSwitchTenant()) {
        <button mat-button [matMenuTriggerFor]="tenantMenu" 
                class="tenant-button flex items-center space-x-2">
          <img [src]="tenantLogo()" 
               [alt]="tenantName()"
        ...
        <mat-menu #tenantMenu="matMenu" class="tenant-menu">
          ...
          @for (tenant of tenants(); track tenant.id) {
            <button mat-menu-item 
                    ...
                    [class.bg-blue-50]="tenant.id === tenantId()">
              <div class="flex items-center space-x-3 w-full">
                <img [src]="tenant.logoUrl || '/assets/default-logo.png'" 
                     [alt]="tenant.name"
                ...
                <mat-card-content class="space-y-4">
                  ...
                  <div class="logo-upload">
                    ...
                    <div class="flex items-center space-x-4">
                      ...
                      <div>
                        <input type="file" #fileInput (change)="onLogoSelect($event)" 
                  ...
                  <mat-form-field appearance="outline" class="w-full">
                    ...
                    <textarea matInput formControlName="customCss" 
                              rows="6" 
                              placeholder=".custom-header { background: #ff0000; }"></textarea>
          ...
          <div class="pt-4">
            <mat-card>
              <mat-card-header>
                ...
                <mat-card-subtitle>
                  Manage which features are available for this organization
                </mat-card-subtitle>
              </mat-card-header>
              <mat-card-content>
                <div class="space-y-4">
                    ...
                    <div class="flex items-center justify-between py-2">
                      <div class="flex-1">
                        ...
                        @if (feature.planRequired) {
                          <mat-chip class="mt-1" color="accent">
                            {{ feature.planRequired }}+ plan required
                          </mat-chip>
                        }
                      </div>
                      ...
                      <mat-slide-toggle 
                        ...
                        [disabled]="!canEnableFeature(feature)"
                        (change)="toggleFeature(feature.key, $event.checked)">
                      </mat-slide-toggle>
                    </div>
                  }
                </div>
                ...
                @if (currentTenant()) {
                  <div class="space-y-4">
                    ...
                    <div class="flex gap-2">
                      ...
                      <button mat-button (click)="viewBilling()">
                        View Billing
                      </button>
                    </div>
                  </div>
...
export const routes: Routes = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        loadComponent: () => import('./features/tenant/tenant-settings.component')
  ...
  {
    path: 'no-tenant',
    loadComponent: () => import('./shared/components/no-tenant.component')
      .then(m => m.NoTenantComponent)
  },
  {
    path: 'upgrade-plan',
    loadComponent: () => import('./shared/components/upgrade-plan.component')
