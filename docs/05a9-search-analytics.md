    ...
    <div class="search-container p-4">
      ...
      <mat-form-field appearance="outline" class="w-full">
        ...
        <input matInput 
               ...
               (focus)="onSearchFocus()"
               placeholder="Type to search users, orders, products...">
                  ...
                  <div class="result-category">
                    ...
                    <div class="space-y-2">
                      @for (result of category.results; track result.id) {
                        <div class="result-item p-3 border rounded hover:bg-gray-50 cursor-pointer"
                          ...
                          <div class="flex items-start justify-between">
                            <div class="flex-1">
                              ...
                              <p class="text-sm text-gray-600 mt-1" 
                                 [innerHTML]="result.content"></p>
                              
                              @if (result.highlights && result.highlights.length > 0) {
                                <div class="mt-2">
                                  @for (highlight of result.highlights; track highlight) {
                                    <span class="inline-block bg-yellow-100 text-yellow-800 px-2 py-1 text-xs rounded mr-1"
                                          [innerHTML]="highlight"></span>
                                  }
                                </div>
                              }
                            </div>
                  ...
                  <div class="metric-item">
                    ...
                    <div class="w-full bg-gray-200 rounded-full h-2 mt-2">
                      <div class="bg-green-500 h-2 rounded-full" 
                           [style.width.%]="getHealthPercentage('responseTime')"></div>
                    </div>
                  </div>
                  ...
                  <div class="metric-item">
                    ...
                    <div class="w-full bg-gray-200 rounded-full h-2 mt-2">
                      <div class="bg-red-500 h-2 rounded-full" 
                           [style.width.%]="systemMetrics()!.errorRate"></div>
                    </div>
                  </div>
...
export class AnalyticsDashboardComponent implements OnInit {
  ...
  private async loadAllMetrics(): Promise<void> {
    ...
    await Promise.all([
      this.analyticsService.loadDashboardAnalytics(period),
      this.analyticsService.loadUserMetrics(period),
      this.analyticsService.loadSystemMetrics()
    ]);
  }
