          ...
          children: [
            {
              ...
              type: 'item',
              icon: 'calendar_today',
              link: '/docs/components/forms/date-picker',
            },
          ],
        },
        // Feedback
          ...
          children: [
            {
              ...
              type: 'item',
              icon: 'notifications',
              link: '/docs/components/feedback/alert',
            },
            {
              id: 'loading-bar',
              title: 'Loading Bar',
              ...
              link: '/docs/components/feedback/loading-bar',
            },
            {
              id: 'dialogs',
              title: 'Dialogs',
              type: 'item',
              icon: 'open_in_new',
              link: '/docs/components/feedback/dialogs',
            },
          ],
        },
        // Navigation
          ...
          children: [
            {
              ...
              type: 'item',
              icon: 'arrow_forward',
              link: '/docs/components/navigation/breadcrumb',
            },
          ],
        },
      ],
