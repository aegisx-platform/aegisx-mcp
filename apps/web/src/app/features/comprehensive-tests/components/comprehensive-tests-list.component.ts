    ...
    <div class="comprehensive-tests-list-container">
      ...
      <mat-card class="export-tools-card">
        <mat-card-header>
          ...
          <mat-card-subtitle
            >Export Comprehensive Tests data in various
        ...
        <mat-card-content>
          ...
          <div class="export-info">
            ...
            <span class="info-text">
              ...
              {{ comprehensiveTestsService.totalComprehensiveTest() }} records
              @if (hasActiveFilters()) {
...
export class ComprehensiveTestListComponent implements OnInit, OnDestroy {
  ...
  readonly selectedItems = computed(() =>
    this.comprehensiveTestsService
  ...
  exportServiceAdapter: ExportService = {
    export: (options: ExportOptions) =>
      this.comprehensiveTestsService.exportComprehensiveTest(options),
  };
