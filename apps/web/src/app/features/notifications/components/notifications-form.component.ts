...
import { Notification, CreateNotificationRequest, UpdateNotificationRequest } from '../types/notification.types';
import { 
  ...
  template: `
    <form [formGroup]="notificationsForm" class="-form">
      ...
      <mat-form-field appearance="outline" class="full-width">
        ...
        >
        <mat-error *ngIf="notificationsForm.get('user_id')?.hasError('required')">
          User Id is required
        </mat-error>
      </mat-form-field>
      ...
      <mat-form-field appearance="outline" class="full-width">
        ...
        <mat-error *ngIf="notificationsForm.get('title')?.hasError('maxlength')">
      ...
      <mat-form-field appearance="outline" class="full-width">
        ...
        <textarea 
          ...
          rows="3"
        ></textarea>
        <mat-error *ngIf="notificationsForm.get('message')?.hasError('required')">
          Message is required
        </mat-error>
        <mat-error *ngIf="notificationsForm.get('message')?.hasError('maxlength')">
      ...
      <mat-form-field appearance="outline" class="full-width">
        ...
        <mat-error *ngIf="notificationsForm.get('data')?.hasError('invalidJson')">
          Invalid JSON format
        </mat-error>
      </mat-form-field>
      ...
      <div class="form-actions">
        ...
        <button 
          ...
          type="button"
          (click)="onSubmit()"
          [disabled]="notificationsForm.invalid || loading || (mode === 'edit' && !hasChanges())"
        >
...
export class NotificationFormComponent implements OnInit, OnChanges {
  ...
  onSubmit() {
    if (this.notificationsForm.valid) {
      const formData = { ...this.notificationsForm.value } as NotificationFormData;
      ...
      if (formData.archived_at) {
        formData.archived_at = formatDateTimeForSubmission(formData.archived_at);
      }
