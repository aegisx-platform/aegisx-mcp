...
@Component({
  selector: 'app-budget-reservations-import-dialog',
  standalone: true,
  imports: [
    CommonModule,
    MatDialogModule,
    ...
    <div class="tremor-dialog-container">
      ...
      <div class="tremor-dialog-header bg-green-50">
        <div class="flex items-center gap-3">
          ...
          <div>
            <h2 class="tremor-dialog-title">Bulk Import Budget Reservations</h2>
              ...
              <div class="preview-section">
                ...
                <div class="table-container">
                  ...
                  >
                    ...
                    <!-- Data Columns -->
                    <ng-container matColumnDef="allocation_id">
                    ...
                    <ng-container matColumnDef="reserved_amount">
                      <th mat-header-cell *matHeaderCellDef>Reserved Amount</th>
                      <td mat-cell *matCellDef="let row">
                        {{ row.reserved_amount }}
                      </td>
                    </ng-container>
        ...
        @if (currentStep() === 'progress' && importJob()) {
          <div class="step-content">
            <div class="progress-container">
              ...
              <h3>Importing Budget Reservations...</h3>
...
export class BudgetReservationImportDialogComponent implements OnDestroy {
  private budgetReservationsService = inject(BudgetReservationService);
  private snackBar = inject(MatSnackBar);
  private dialogRef = inject(
    MatDialogRef<BudgetReservationImportDialogComponent>,
  );
    ...
    this.budgetReservationsService
      ...
      .subscribe({
        next: (blob) => {
          ...
          link.href = url;
          link.download = `budget-reservations-import-template.${format === 'excel' ? 'xlsx' : 'csv'}`;
          link.click();
  ...
  async validateFile(): Promise<void> {
    ...
    try {
      const response =
        await this.budgetReservationsService.validateImportFile(file);
  ...
  async executeImport(): Promise<void> {
    ...
    try {
      const response = await this.budgetReservationsService.executeImport(
  ...
  private startPolling(jobId: string): void {
    this.pollingInterval = setInterval(async () => {
      try {
        const response =
          await this.budgetReservationsService.getImportStatus(jobId);
