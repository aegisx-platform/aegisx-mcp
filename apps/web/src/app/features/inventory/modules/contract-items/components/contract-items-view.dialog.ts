...
import { ContractItem } from '../types/contract-items.types';

export interface ContractItemViewDialogData {
  contractItems: ContractItem;
}

@Component({
  selector: 'app-contract-items-view-dialog',
  standalone: true,
  ...
  template: `
    ...
    <h2 mat-dialog-title class="ax-header ax-header-neutral">
      ...
      <div class="header-text">
        <div class="ax-title">ContractItem Details</div>
      ...
      <div class="ax-dialog-section">
        ...
        <div class="ax-dialog-section-content">
          <div class="ax-dialog-field-row">
            <div class="ax-dialog-field-label">Contract Id</div>
            <div class="ax-dialog-field-value">
              {{ data.contractItems?.contract_id ?? '-' }}
            </div>
          </div>
          <div class="ax-dialog-field-row">
            <div class="ax-dialog-field-label">Generic Id</div>
            <div class="ax-dialog-field-value">
              {{ data.contractItems?.generic_id ?? '-' }}
            </div>
          </div>
          <div class="ax-dialog-field-row">
            <div class="ax-dialog-field-label">Agreed Unit Price</div>
            <div class="ax-dialog-field-value">
              {{ data.contractItems?.agreed_unit_price ?? '-' }}
            </div>
          </div>
          <div class="ax-dialog-field-row">
            <div class="ax-dialog-field-label">Quantity Limit</div>
            <div class="ax-dialog-field-value">
              {{ data.contractItems?.quantity_limit ?? '-' }}
            </div>
          </div>
          <div class="ax-dialog-field-row">
            <div class="ax-dialog-field-label">Quantity Used</div>
            <div class="ax-dialog-field-value">
              {{ data.contractItems?.quantity_used ?? '-' }}
            </div>
          </div>
          <div class="ax-dialog-field-row">
            <div class="ax-dialog-field-label">Notes</div>
            <div class="ax-dialog-field-value">
              {{ data.contractItems?.notes || '-' }}
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="ax-dialog-section">
        ...
        <div class="ax-dialog-section-content ax-dialog-section-metadata">
          <div class="ax-dialog-field-row">
            ...
            <div class="ax-dialog-field-value">
              <code>{{ data.contractItems?.id }}</code>
            </div>
          </div>
          <div class="ax-dialog-field-row">
            <div class="ax-dialog-field-label">Created At</div>
            <div class="ax-dialog-field-value">
              {{ data.contractItems?.created_at | date: 'medium' }}
            </div>
          </div>
          <div class="ax-dialog-field-row">
            <div class="ax-dialog-field-label">Updated At</div>
            <div class="ax-dialog-field-value">
              {{ data.contractItems?.updated_at | date: 'medium' }}
            </div>
          </div>
        </div>
      </div>
...
export class ContractItemViewDialogComponent {
  private dialogRef = inject(MatDialogRef<ContractItemViewDialogComponent>);
  protected data = inject<ContractItemViewDialogData>(MAT_DIALOG_DATA);
  ...
  onEdit() {
    this.dialogRef.close({ action: 'edit', data: this.data.contractItems });
  }
}
