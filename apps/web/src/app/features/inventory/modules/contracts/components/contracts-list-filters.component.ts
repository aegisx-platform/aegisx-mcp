...
@Component({
  selector: 'app-contracts-list-filters',
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
        ...
        <div class="mt-4 pt-4 border-t border-[var(--ax-border-default)]">
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <mat-form-field appearance="outline" class="w-full">
              ...
              <input
                matInput
                [(ngModel)]="contract_numberFilter"
                (ngModelChange)="contract_numberFilterChange.emit($event)"
            ...
            <mat-form-field appearance="outline" class="w-full">
              ...
              <input
                matInput
                [(ngModel)]="fiscal_yearFilter"
                (ngModelChange)="fiscal_yearFilterChange.emit($event)"
                (keyup.enter)="applyFiltersClicked.emit()"
            ...
            <mat-form-field appearance="outline" class="w-full">
              ...
              <input
                matInput
                [(ngModel)]="egp_numberFilter"
                (ngModelChange)="egp_numberFilterChange.emit($event)"
                (keyup.enter)="applyFiltersClicked.emit()"
            ...
            <mat-form-field appearance="outline" class="w-full">
              ...
              <input
                matInput
                [(ngModel)]="project_numberFilter"
                (ngModelChange)="project_numberFilterChange.emit($event)"
                (keyup.enter)="applyFiltersClicked.emit()"
...
export class ContractsListFiltersComponent {
  ...
  // Contract Number filter
  @Input() contract_numberFilter = '';
  @Output() contract_numberFilterChange = new EventEmitter<string>();
  // Fiscal Year filter
  @Input() fiscal_yearFilter = '';
  @Output() fiscal_yearFilterChange = new EventEmitter<string>();
  // Egp Number filter
  @Input() egp_numberFilter = '';
  @Output() egp_numberFilterChange = new EventEmitter<string>();
  // Project Number filter
  @Input() project_numberFilter = '';
  @Output() project_numberFilterChange = new EventEmitter<string>();
