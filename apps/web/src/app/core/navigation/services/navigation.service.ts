      ...
      children: [
        {
          ...
          type: 'item',
          icon: 'dashboard',
          link: '/system/monitoring/dashboard',
          permissions: ['monitoring:view', '*:*'],
        },
        {
        ...
        },
        {
          ...
          type: 'item',
          icon: 'bug_report',
          link: '/system/monitoring/error-logs',
        ...
        },
        {
          ...
          type: 'item',
          icon: 'history',
          link: '/system/monitoring/activity-logs',
      ...
      children: [
        {
          ...
          type: 'item',
          icon: 'login',
          link: '/system/audit/login-attempts',
          permissions: ['audit:read', '*:*'],
        },
        {
          id: 'file-audit',
