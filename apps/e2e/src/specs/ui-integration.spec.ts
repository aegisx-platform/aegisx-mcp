...
test.describe('UI Integration Tests', () => {
  ...
  test('should display the dashboard page with proper layout', async ({ page }) => {
    ...
    const totalUsersCard = await page.locator('ax-card:has-text("Total Users")');
  ...
  test('should navigate to component showcase pages', async ({ page }) => {
    // Navigate to buttons page
    await page.goto('/components/buttons');
    await expect(page.locator('h1:has-text("Button Components")')).toBeVisible();
  ...
  test('should display Material Design components with proper styling', async ({ page }) => {
    await page.goto('/components/buttons');
  ...
  test('should display alerts with proper styling', async ({ page }) => {
    await page.goto('/dashboard');
  ...
  test('should have working form controls', async ({ page }) => {
    ...
    const countrySelect = await page.locator('mat-select[formControlName="country"]');
  ...
  test('should display tables with sorting and pagination', async ({ page }) => {
    await page.goto('/components/tables');
  ...
  test('should capture visual screenshots', async ({ page }) => {
