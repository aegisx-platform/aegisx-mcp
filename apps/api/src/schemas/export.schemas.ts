...
export const ExportQuerySchema = Type.Object(
  {
    ...
    filename: Type.Optional(
      Type.String({
        ...
        pattern: '^[a-zA-Z0-9._-]+$',
        description:
          'Custom filename (can include dots, underscores, and hyphens)',
      }),
    ),
...
export const ExportConfigSchema = Type.Object(
  {
    ...
    defaultFields: Type.Optional(
      Type.Array(ExportFieldSchema, {
        description: 'Default field configuration for exports',
      }),
    ),

    allowCustomFields: Type.Optional(
      Type.Boolean({
        default: true,
...
export const ExportProgressSchema = Type.Object(
  {
    ...
    estimatedTimeRemaining: Type.Optional(
      Type.Number({
        minimum: 0,
