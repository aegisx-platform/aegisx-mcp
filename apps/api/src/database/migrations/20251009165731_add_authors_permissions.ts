 ...
 * Generated by CRUD Generator on 2025-10-09T16:57:31.768Z
 */
...
export async function up(knex: Knex): Promise<void> {
  ...
  if (mainRole) {
    ...
    if (mainPermissions.length > 0) {
      ...
      console.log(`🔗 Linking ${ mainPermissions.length} permissions to authors role...`);
...
export async function down(knex: Knex): Promise<void> {
  ...
  console.log(`✅ Removed ${deletedRoles} roles and ${deletedPermissions} permissions for authors`);
}