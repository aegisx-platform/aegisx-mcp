...
export async function up(knex: Knex): Promise<void> {
  ...
  await createPermissions(knex, TESTCATEGORIES_PERMISSIONS, {
    ...
    // Note: assignToAdmin is not needed because admin inherits via parent_id
  });
