...
export async function pdfTemplateRoutes(fastify: FastifyInstance) {
  ...
  }, async (request: FastifyRequest<{ Body: Static<typeof CreatePdfTemplateSchema> }>, reply: FastifyReply) => {
    try {
  ...
  fastify.get<{
    ...
    preValidation: [fastify.authenticate]
  }, async (request: FastifyRequest<{ Params: Static<typeof PdfTemplateIdParamSchema> }>, reply: FastifyReply) => {
    try {
      ...
      request.log.error({ error, templateId: request.params.id }, 'Failed to get PDF template');
  ...
  fastify.get<{
    ...
    preValidation: [fastify.authenticate]
  }, async (request: FastifyRequest<{ Querystring: Static<typeof PdfTemplateListQuerySchema> }>, reply: FastifyReply) => {
    try {
  ...
  fastify.put<{
    ...
    try {
      ...
      request.log.error({ error, templateId: request.params.id }, 'Failed to update PDF template');
  ...
  fastify.delete<{
    ...
    try {
      ...
      request.log.error({ error, templateId: request.params.id }, 'Failed to delete PDF template');
  ...
  fastify.post<{
    ...
    preValidation: [fastify.authenticate]
  }, async (request: FastifyRequest<{ Body: Static<typeof PdfRenderRequestSchema> }>, reply: FastifyReply) => {
    try {
      ...
      if ((result as any).buffer) {
        ...
        reply
          ...
          .header('Content-Disposition', `inline; filename="${result.filename || 'document.pdf'}"`)
  ...
  fastify.post<{
    ...
    try {
      ...
      request.log.error({ error, templateId: request.params.id }, 'Failed to preview template');
  ...
  fastify.post<{
    ...
    preValidation: [fastify.authenticate]
  }, async (request: FastifyRequest<{ Body: { template_data: any } }>, reply: FastifyReply) => {
    try {
      const validation = templateService.validateTemplate(request.body.template_data);
  ...
  fastify.get<{
    ...
    preValidation: [fastify.authenticate]
  }, async (request: FastifyRequest<{ Querystring: Static<typeof PdfTemplateSearchQuerySchema> }>, reply: FastifyReply) => {
    try {
      const templates = await templateService.searchTemplates(request.query.q);
  ...
  fastify.post<{
    ...
    try {
      ...
      request.log.error({ error, templateId: request.params.id }, 'Failed to duplicate template');
  ...
  fastify.get<{
    ...
    try {
      const versions = await templateService.getTemplateVersions(request.params.id);
      ...
      request.log.error({ error, templateId: request.params.id }, 'Failed to get template versions');
